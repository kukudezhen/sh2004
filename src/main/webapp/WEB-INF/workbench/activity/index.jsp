    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar" style="height: 80px;">
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <button type="button" id="activityQueryBtn" onclick="大傻逼()"  class="btn btn-default">查询</button>
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    $('#activityList').append("<tr class=\"active\">\n" +
                        "\t\t\t\t\t\t\t<td><input type=\"checkbox\" /></td>\n" +
                        "\t\t\t\t\t\t\t<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='detail.html';\">" + dataList.name + "</a></td>\n" +
                        "                            <td>" + dataList.owner + "</td>\n" +
